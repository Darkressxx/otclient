...
locale = {
  ...
  translation = {
    ...
    ["Auto login selected character on next charlist load"] = "Ingresar automáticamente en el personaje seleccionado la próxima vez que aparezca la lista de personajes.",
    ["Axe Fighting"] = "Combate con hacha",
    ["Balance:"] = "Saldo:",
    ["Banishment"] = "Destierro",
    ["Banishment + Final Warning"] = "Destierro y última advertencia",
    ["Battle"] = "Batalla",
    ["Browse"] = "Navegar",
    ...
    ["Clear current message window"] = "Limpiar mensajes de la pestaña",
    ["Clear Messages"] = "Limpiar mensajes",
    ["Clear object"] = "Limpiar objeto",
    ["Client needs update."] = "El cliente necesita ser actualizado.",
    ["Close"] = "Cerrar",
    ...
    ["Current hotkeys:"] = "Actual tecla de acceso directo:",
    ["Current hotkey to add: %s"] = "Tecla de acceso directo a agregar: %s",
    ...
    ["Edit hotkey text:"] = "Editar texto de tecla de acceso rapido:",
    ...
    ["Error"] = "Error",
    ["Error"] = "Error",
    ["Excessive Unjustified Player Killing"] = "Asesinatos excesivos de jugadores injustificados",
    ["Exclude from private chat"] = "Ejecutar desde un canal privado",
    ["Exit"] = "Salir",
    ["Experience"] = "Experiencia",
    ["Filter list to match your level"] = "Lista de filtros que coincida con tu nivel",
    ["Filter list to match your vocation"] = "Lista de filtros que coincida con tu vocación",
    ["Find:"] = "Encontrar:",
    ["Fishing"] = "Pesca",
    ...
    ["Graphics"] = "Gráficos",
    ["Graphics card driver not detected"] = "Controlador de tarjeta gráfica no detectado",
    ["Graphics Engine:"] = "Motor Gráfico:",
    ["Head"] = "Cabeza",
    ["Healing"] = "Curación",
    ["Health Info"] = "Info. de salud",
    ["Health Information"] = "Información de salud",
    ["Hide monsters"] = "Ocultar monstruos",
    ["Hide non-skull players"] = "Ocultar jugadores sin  ",
    ["Hide Npcs"] = "Ocultar PNJs",
    ["Hide Offline"] = "Ocultar jugadores desconectados",
    ["Hide party members"] = "Ocultar miembros del grupo",
    ["Hide players"] = "Ocultar jugadores",
    ["Hide spells for higher exp. levels"] = "Ocultar hechizos para niveles mas altos que tu.",
    ["Hide spells for other vocations"] = "Ocultar hechizos que sean para otra vocación",
    ["Hit Points"] = "Puntos de salud",
    ["Hold left mouse button to navigate\nScroll mouse middle button to zoom\nRight mouse button to create map marks\nPress Ctrl+Shift+M to view the entire game map"] = "Mantenga presionado el botón derecho del ratón para navegar,\nDezplaze la rueda central del ratón para ampliar,\nbotón derecho del mouse para crear marcas del mapa,\nPresione Ctrl+Shift+M para ver el mapa completo.",
    ["Hotkeys"] = "Teclas de acceso rápido",
    ["If you shut down the program, your character might stay in the game.\nClick on 'Logout' to ensure that you character leaves the game properly.\nClick on 'Exit' if you want to exit the program without logging out your character."] = "Si se cierra el programa, tu personaje puede que permanesca en el juego.\nHaga clic en 'Salir' para asegurarse de que personaje salga del juego correctamente.\nHaga click en 'Forzar salida' si desea salir del programa sin tener que salir de tu personaje.",
    ["Ignore"] = "Ignorar",
    ...
    ["Mana"] = "Mana",
    ["Manage hotkeys:"] = "Administrador de teclas de acceso rápido:",
    ["Market"] = "Mercado",
    ...
    ["Offline Training"] = "Entrenamiento fuera de linea",
    ["Ok"] = "OK",
    ["on %s.\n"] = "en %s.\n",
    ["Open"] = "Abierto",
    ...
    ["Please, press the key you wish to add onto your hotkeys manager"] = "Por favor, presiona la tecla que desea utilizar como\ntecla de acceso rápido",
    ...
    ["Premium Account (%s) days left"] = "Tienes (%s) días de cuenta Premium restantes",
    ["Price:"] = "Precio:",
    ["Primary"] = "Primario",
    ["Protocol"] = "Protocolo",
    ["Quest Log"] = "Registro de misiones",
    ["Randomize"] = "Selección aleatoria",
    ["Randomize characters outfit"] = "Selección aleatoria de vestimenta del jugador",
    ["Reason:"] = "Razón:",
    ["Refresh"] = "Refrescar",
    ["Refresh Offers"] = "Refrescar ofertas",
    ["Regeneration Time"] = "Tiempo de regeneración",
    ["Reject"] = "Rechazar",
    ["Reload All"] = "Cargar todo",
    ...
    ["Select your language"] = "Selectiona tu lenguaje",
    ["Sell"] = "Vender",
    ...
    ["Show Depot Only"] = "Mostrar solo el almacén",
    ...
    ["Special"] = "Especial",
    ["Speed"] = "Velocidad",
    ["Spell Cooldowns"] = "Enfriamentos de hechizos",
    ["Spell List"] = "Lista de hechizos",
    ["Stamina"] = "Resistencia",
    ["Statement:"] = "Comentario:",
    ["Statement Report"] = "Reportar comentario",
    ...
    ["You are hasted"] = "Tu vas deprisa", -- Muchas variables.
    ...
    ["You have %s percent"] = "Tu tienes %s porciento",
    ["You have %d%% to advance to level %d."] = "Tu tienes %d%% para avanzar al nivel %d.",
    ["You have %s percent to go"] = "Tu necesitas %s porciento para subir",
	...
	["You cannont use this object"] = "Tu no puedes utilizar este object",
	["Global ignore settings"] = "Ajustes globales para ignorados",
	["Global whitelist settings"] = "Ajustes globales para la lista blanca",
	["Ignored Players:"] = "Jugadores ignorados:",
	["Allowed Players:"] = "Jugadores aceptados:",
	["Allow VIPs to message you"] = "Permitir a jugadores agregados enviarte mensajes",
	["Activate ignorelist"] = "Activar lista de ignorados",
	["Activate whitelist"] = "Activar lista blanca",
	["Select all"] = "Seleccionar mensaje",
	["%s of experience left"] = "%s de experiencia restante.",
	["%d of experience per hour"] = "%d de experiencia por hora",
	["Your character health is %d out of %d."] = "La salud actual de su personaje es %d de %d.",
	["Your character mana is %d out of %d."] = "La mana actual de su personaje es %d de %d.",
   	["Distance"] = "Distancia",
   	["Age"] = "Edad",
	["Health"] = "Salud",
  }
...
--- Darkressxx: translate somethings.
